...
--
-- Host: localhost    Database: sistemaportaria
-- ------------------------------------------------------
...
INSERT INTO `funcionario` VALUES (1,'Maria Antonia','12345','12345678912','usuario'),(2,'Jose Quintino','54321','65432175469','usuario1'),(3,'Jairo Augusto','12354','65412365134','usuario2');
...
INSERT INTO `morador` VALUES (1,'Paloma Dias Pinheiro','12345678912','10','1'),(2,'Gabriela Souza','54123678954','14','3'),(3,'Barbara Costa ','48579612348','11','3');
...
CREATE TABLE `visitante` (
  ...
  `numero_apartamento_morador` varchar(45) DEFAULT NULL,
  `bloco_morador` varchar(45) DEFAULT NULL,
  `data_visita` datetime DEFAULT NULL,
  PRIMARY KEY (`id_visitante`),
  KEY `id_morador` (`id_morador`),
  CONSTRAINT `visitante_ibfk_1` FOREIGN KEY (`id_morador`) REFERENCES `morador` (`id_morador`)
...
-- Dump completed on 2023-06-10 16:20:49
